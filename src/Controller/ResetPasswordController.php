...
class ResetPasswordController extends AbstractController
{
     ...
     *
     * @Route("/reset/{token}", name="app_reset_password", methods={"GET", "PUT"})
     */
    public function reset(Request $request, UserPasswordEncoderInterface $passwordEncoder, string $token = null): Response
    {
        ...
        try {
            ...
            $this->addFlash('danger', 'Erreur, impossible de réinitialiser votre mot de passe, veuillez réessayer plus tard.');
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, Swift_Mailer $mailer): RedirectResponse
    {
        ...
        $email = (new Swift_Message('Votre requête de réinitialisation de mot de passe'))
            ->setFrom($this->getParameter('mailer.mail'), 'MuscuProject')
            ->setTo($user->getEmail())
            ->setBody(
                $this->render('reset_password/email.html.twig', [
